  ...
  return (
    <div style={{ position: 'fixed', inset: 0, width: '100vw', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'var(--bg)', zIndex: 9999 }}>
      <div style={{ textAlign: 'center' }}>
        <img src="/logo.png" alt="Evolvio Logo" style={{ width: '120px', height: '120px', borderRadius: '50%', marginBottom: '1.5rem', border: '3px solid var(--border)', objectFit: 'cover', animation: 'pulse 2s infinite' }} />
        <h1 style={{ fontSize: '3rem', background: 'linear-gradient(45deg, #3b82f6, #10b981)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', marginBottom: '0.5rem' }}>Evolvio</h1>
